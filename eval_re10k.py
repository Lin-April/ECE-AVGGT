...
def output_paths(data_root, args):
    ...
    return {
        "results": results_dir / f"re10k_manifest_eval{suffix}.json",
        "manifest": results_dir / f"re10k_manifest_eval_frames{suffix}.csv",
        "profile": results_dir / f"re10k_profile{suffix}.json",
    }
